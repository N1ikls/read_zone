...
<template>
  <div class="light:bg-[#ffffff] shadow rounded-[20px] p-4">
    <div
    ...
    >
      <div class="text-[16px] whitespace-pre-wrap">
        <p>
          Разгильдяй третий принц королевства Бриоль, Юрий, в последний момент
          гибели королевства смог спастись бегством и сохранить себе жизнь.
          Блуждая в отчаянии, полном сожаления и чувства вины, Юрий в конце
          концов встретил смерть… И вдруг, открыв глаза, увидел перед собой
          знакомое лицо своего отца?! Он подумал, что они с королем вместе
          попали в ад. — Отец… Вы в конце концов тоже оказались в аду… — Что? —
          Впрочем… Говорил о чести, а жил как распоследний развратник… — Что за
          чушь ты несёшь?! Но… это оказался не ад, а возвращение в весну, когда
          ему было всего тринадцать лет?! Разгильдяй третий принц королевства
          Бриоль, Юрий, в последний момент гибели королевства смог спастись
          бегством и сохранить себе жизнь. Блуждая в отчаянии, полном сожаления
          и чувства вины, Юрий в конце концов встретил смерть… И вдруг, открыв
          глаза, увидел перед собой знакомое лицо своего отца?! Он подумал, что
          они с королем вместе попали в ад. — Отец… Вы в конце концов тоже
          оказались в аду… — Что? — Впрочем… Говорил о чести, а жил как
          распоследний развратник… — Что за чушь ты несёшь?! Но… это оказался не
          ад, а возвращение в весну, когда ему было всего тринадцать лет?!
          Разгильдяй третий принц королевства Бриоль, Юрий, в последний момент
          гибели королевства смог спастись бегством и сохранить себе жизнь.
          Блуждая в отчаянии, полном сожаления и чувства вины, Юрий в конце
          концов встретил смерть… И вдруг, открыв глаза, увидел перед собой
  ...
  <div class="light:bg-[#ffffff] shadow rounded-[20px] p-4 my-4">
